...
public class ContainerTrd extends Container {
	...
	// @Override
	// public ItemStack transferStackInSlot(EntityPlayer playerIn, int
	// slotIndex) {
	...
	// // slots
	// {
	// if (!mergeItemStack(itemStack2, sizeInventory + 27, sizeInventory + 36,
	// false)) {
	// return null;
	// }
	// } else if (slotIndex >= sizeInventory + 27 && slotIndex < sizeInventory +
	// 36
	// && !mergeItemStack(itemStack2, sizeInventory + 1, sizeInventory + 27,
	// false)) // hotbar
	// // slots
	// {
	// return null;
	// }
	// } else if (!mergeItemStack(itemStack2, sizeInventory, sizeInventory + 36,
	// false)) {
	// return null;
	// }
	//
